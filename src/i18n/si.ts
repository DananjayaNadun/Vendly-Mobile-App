...
export const si: Catalogue = {
  ...
  'notFound.title': 'සොයාගත නොහැකි විය',
  ...
  'shop.goodMorning': 'සුබ උදෑසනක්',
  'shop.itemQty': '{name} × {qty}',
  'shop.stockGood': 'හොඳයි',
  'shop.stockLow': 'අඩුයි',
  'shop.stockOut': 'තොගයේ නැත',
  'shop.codLow': 'අඩු',
  'shop.codMedium': 'මධ්‍යම',
  'shop.codHigh': 'COD : ඉහළ',
  'shop.courierActive': 'ක්‍රියාකාරී',
  'shop.courierPending': 'නොවිසඳූ',
  'shop.lastOrder': 'අවසන් ඇණවුම {ago}',
  'shop.agoHours': 'පැය {n}කට පෙර',
  'shop.agoDays': 'දින {n}කට පෙර',
  'shop.courierSettled': 'ක්‍රියාකාරී {count} · COD සතිපතා පියවේ',
  'shop.courierWaybills': 'ක්‍රියාකාරී {count} · වේබිල් {waybills}ක් නොවිසඳූ',
  'shop.language': 'භාෂාව',
  'shop.chooseLanguage': 'ඔබේ භාෂාව තෝරන්න',
  'shop.noNotifications': 'දැනට අලුත් කිසිවක් නැත',
  'shop.noNotificationsSub': 'නව ඇණවුම් සහ COD අනතුරු ඇඟවීම් මෙහි එයි',
  'shop.addProduct': 'භාණ්ඩයක් එකතු කරන්න',
  'shop.addProductSoon': 'භාණ්ඩයක් එකතු කිරීමට භාණ්ඩ පෝරමය අවශ්‍යයි, එය තවම සාදා නැත.',
  'shop.adjustStock': 'තොගය සකසන්න',
  'shop.stockSaved': '{product} දැන් තොගයේ {count}ක්',
  'shop.customerActions': '{name} සම්බන්ධ කරගන්න',
  'shop.viewOrders': 'ඔවුන්ගේ ඇණවුම් බලන්න',
  'shop.connectCourier': 'කූරියර් සේවයක් සම්බන්ධ කරන්න',
  'shop.courierConnected': '{courier} සම්බන්ධ කළා',
  'shop.noneToConnect': 'සියලුම කූරියර් සේවා දැනටමත් සම්බන්ධයි.',
  'shop.waybillsExported': 'වේබිල් බෙදාගත්තා',
  'shop.reportShared': 'වාර්තාව WhatsApp වෙත බෙදාගත්තා',
  'shop.reportMessage': '{shop} — ආදායම LKR {revenue}, ඇණවුම් {orders}, සාමාන්‍යය LKR {average}, ශුද්ධ ලාභය LKR {profit}.',
  'shop.waybillMessage': '{shop} — රැගෙන යාමට නොවිසඳූ වේබිල් {count}ක්.',
  'shop.socialSoon': '{provider} පිවිසුමට මෙම යෙදුම සඳහා OAuth සේවාදායකයෙක් අවශ්‍යයි.',
  'shop.revenueDelta': 'ඊයේට වඩා {pct}%',
  'shop.deltaToday': 'අද {n}',
  'shop.deltaOrders': 'ඇණවුම් {n}',
  'shop.deltaCodIssues': 'COD ගැටලු',
  'shop.period7': 'දින 7',
  'shop.period30': 'දින 30',
  'shop.period90': 'මාස 3',
  'shop.perDay': 'දෛනික',
  'shop.perWeek': 'සතිපතා',
  'shop.perMonth': 'මාසික',
  'shop.vsPrevious': 'පෙර {period} හා සසඳා',
  'shop.trend': 'ප්‍රවණතාව',
  'shop.metricRevenue': 'ආදායම',
  'shop.metricOrders': 'ඇණවුම්',
  'shop.tapPoint': 'විස්තර බැලීමට ලක්ෂ්‍යයක් තට්ටු කරන්න',
  'shop.channels': 'ඇණවුම් එන්නේ කොහෙන්ද',
  'shop.channelsSub': 'නාලිකා {n}ක් හරහා ඇණවුම් {count}ක්',
  'shop.topProducts': 'වැඩියෙන් අලෙවි වූ',
  'shop.topProductsSub': 'මෙම කාලයේ ආදායම අනුව',
  'shop.unitsSold': '{n}ක් අලෙවි විය',
  'shop.shareReport': 'බෙදන්න',
  'shop.noData': 'තවම වාර්තා කිරීමට කිසිවක් නැත',
  'shop.noDataSub': 'ඇණවුම් පැමිණීම ඇරඹූ පසු සංඛ්‍යා මෙහි පෙනේ.',
  'axis.mon': 'සඳු',
  'axis.tue': 'අඟ',
  'axis.wed': 'බදා',
  'axis.thu': 'බ්‍රහ',
  ...
  'shop.save': 'සුරකින්න',
  'shop.profileSaved': 'ව්‍යාපාරික තොරතුරු සුරැකිණි',
  ...
  'auth.emailInvalid': 'වලංගු විද්‍යුත් තැපැල් ලිපිනයක් ඇතුළත් කරන්න',
  ...
  'auth.resend': 'කේතය නැවත එවන්න',
  'auth.resent': 'කේතය නැවත එවා ඇත',
  'auth.codeExpired': 'කේතයේ කාලය ඉකුත් විය — අලුත් එකක් ඉල්ලන්න',
